...
namespace System.Data.Entity.Core.Metadata.Edm
{
    ...
    public class ComplexType : StructuralType
    {
        ...
        /// .
        /// </returns>
        public virtual ReadOnlyMetadataCollection<EdmProperty> Properties => new FilteredReadOnlyMetadataCollection<EdmProperty, EdmMember>(
    ...
    internal sealed class ClrComplexType : ComplexType
    {
        ...
        {
            get => _constructor;
            set => Interlocked.CompareExchange(ref _constructor, value, null);
        }
