...
namespace System.Data.Entity.ModelConfiguration.Configuration
{
    ...
    public class PropertyConventionConfiguration
    {
        ...
        /// </returns>
        public PropertyConventionConfiguration Where(System.Func<PropertyInfo, bool> predicate)
        {
            Check.NotNull(predicate, "predicate");

            _predicates.Append(predicate);
            return new PropertyConventionConfiguration(_conventionsConfiguration, _predicates);
        }
