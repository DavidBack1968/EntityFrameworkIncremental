...
namespace System.Data.Entity.ModelConfiguration.Conventions.Sets
{
    ...
    internal class ConventionSet
    {
        ...
        public IEnumerable<IConvention> ConfigurationConventions              { get; }
        public IEnumerable<IConvention> ConceptualModelConventions            { get; }
        public IEnumerable<IConvention> ConceptualToStoreMappingConventions { get; }
        public IEnumerable<IConvention> StoreModelConventions                 { get; }
    }
}
