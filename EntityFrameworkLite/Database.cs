...
namespace System.Data.Entity
{
    ...
    public class Database
    {
        ...
        {
            get => DbConfiguration.DependencyResolver.GetService<IDbConnectionFactory>();
            set
            {
        ...
        // </summary>
        internal static bool DefaultConnectionFactoryChanged => !ReferenceEquals(_defaultConnectionFactory, _defaultDefaultConnectionFactory);
        ...
        {
            get => _internalContext.CommandTimeout;
            set
            {
                if (value.HasValue
                    && value < 0)
